  ...
  const onEachFeature = (feature, layer) => {
    ...
    layer.bindPopup(() => {
      ...
      Object.keys(feature.properties).map((key, index) => {
        content +=
          '<div classn="grid grid-cols-3 gap-2"><div><strong>' +
          key +
          ':</strong></div><div className="col-span-2">' +
          ...
          <div className="p-3">
            ...
            {geojsonData && (
              <div className="flex gap-2 mt-3">
                <input type="text" value={newUrl} className=" inputArea" readOnly />
                <button onClick={downloadJson} className="btnPrimary">Download</button>
              </div>
            )}
          </div>
        </div>
